            ...
            <div class="col-md-4">
                <div class="card card-user">
                    ...
                    <div class="card-body">
                        <div class="author">
                            <a href="#">
                                <img class="avatar border-gray" src="{{asset('images/'.auth()->user()->image)}}" alt="no photo" width="20px" height="30px">
            ...
            <div class="col-md-8 text-center">
                <form class="col-md-12" action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                              <label class="col-md-3 col-form-label">{{ __('Upload Foto') }}</label>
                              <div class="col-sm-7">
